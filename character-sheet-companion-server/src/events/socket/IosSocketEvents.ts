...
export class IosSocketEvents implements SocketEvents {
  ...
  IOS_EVENTS = {
    SETUP: {
      ...
      COMPLETE: EVENT_TYPES.SOCKET.IOS + BASE_EVENTS.SETUP.COMPLETE,
    },
    ACTOR: {
    ...
    ACTOR_CHANGE: {
      HEALTH: EVENT_TYPES.SOCKET.IOS + BASE_EVENTS.ACTOR_CHANGE.HEALTH,
    ...
    DISPLAY: {
      ITEM: EVENT_TYPES.SOCKET.IOS + BASE_EVENTS.DISPLAY.ITEM,
