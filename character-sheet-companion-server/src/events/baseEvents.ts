...
export const BASE_EVENTS = {
  SETUP: {
    ...
    SETUP_COMPLETE: EVENT_TYPES.GENERAL.SETUP + CORE_EVENTS.SETUP_COMPLETE,
  },
  ACTOR: {
    ATTRIBUTES: EVENT_TYPES.GENERAL.ACTOR + CORE_EVENTS.ATTRIBUTES,
    ABILITIES: EVENT_TYPES.GENERAL.ACTOR + CORE_EVENTS.ATTRIBUTES,
  ...
  ACTOR_CHANGE: {
    HEALTH_CHANGE: EVENT_TYPES.GENERAL.ACTOR + CORE_EVENTS.HEALTH_CHANGE,
