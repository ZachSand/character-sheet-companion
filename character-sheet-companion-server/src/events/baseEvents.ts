...
export const BASE_EVENTS = {
  ...
  ACTOR_CHANGE: {
    HEALTH: EVENT_TYPES.GENERAL.ACTOR_CHANGE + CORE_EVENTS.HEALTH_CHANGE,
    LONG_REST: EVENT_TYPES.GENERAL.ACTOR_CHANGE + CORE_EVENTS.LONG_REST,
    SHORT_REST: EVENT_TYPES.GENERAL.ACTOR_CHANGE + CORE_EVENTS.SHORT_REST,
  },
  ROLL: {
