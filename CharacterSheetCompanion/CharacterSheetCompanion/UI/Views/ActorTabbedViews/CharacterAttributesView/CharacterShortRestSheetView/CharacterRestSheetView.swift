...
struct CharacterRestSheetView: View {
    ...
    var characterRestVM: CharacterRestSheetViewModel
        ...
        VStack {
            ...
            if let classes = self.classes {
                ...
                if let selectedActorClass = selectedClass {
                    Button("Roll Hit Die") {
                        characterRestVM.rollHitDie(actorClass: selectedActorClass)
                    }
    ...
    struct CharacterShortRestSheetView_Previews: PreviewProvider {
        ...
        static var previews: some View {
            CharacterRestSheetView(classes: $classes, attributes: $attributes, characterRestVM: CharacterRestSheetViewModel())
        }
    }
#endif
