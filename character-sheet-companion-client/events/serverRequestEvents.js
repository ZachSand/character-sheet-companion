...
export const SERVER_REQUEST_EVENTS = {
  SETUP: {
    WORLD_USERS:
    ...
    COMPLETE: EVENT_TYPES.SOCKET.SERVER_REQUEST + BASE_EVENTS.SETUP.COMPLETE,
  },
  ACTOR: {
    ATTRIBUTES:
      EVENT_TYPES.SOCKET.SERVER_REQUEST + BASE_EVENTS.ACTOR.ATTRIBUTES,
    ABILITIES: EVENT_TYPES.SOCKET.SERVER_REQUEST + BASE_EVENTS.ACTOR.ABILITIES,
    ...
    INVENTORY: EVENT_TYPES.SOCKET.SERVER_REQUEST + BASE_EVENTS.ACTOR.INVENTORY,
    ...
    BASE_DATA: EVENT_TYPES.SOCKET.SERVER_REQUEST + BASE_EVENTS.ACTOR.BASE_DATA,
  ...
  ACTOR_CHANGE: {
    HEALTH: EVENT_TYPES.SOCKET.SERVER_REQUEST + BASE_EVENTS.ACTOR_CHANGE.HEALTH,
    LONG_REST:
  ...
  ROLL: {
    ...
    INITIATIVE: EVENT_TYPES.SOCKET.SERVER_REQUEST + BASE_EVENTS.ROLL.INITIATIVE,
    DEATH_SAVE: EVENT_TYPES.SOCKET.SERVER_REQUEST + BASE_EVENTS.ROLL.DEATH_SAVE,
  ...
  DISPLAY: {
    ...
    DISPLAY_ITEM: EVENT_TYPES.SOCKET.SERVER_REQUEST + BASE_EVENTS.DISPLAY.ITEM,
  },
};
